...
ActiveRecord::Schema.define(version: 2021_12_14_071748) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.index ["playwall_post_id"], name: "index_comments_on_playwall_post_id"
  ...
  add_foreign_key "comments", "playwall_posts"
